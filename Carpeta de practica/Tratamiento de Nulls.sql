...
-- calculo de las ventas promedio por suponer el a�o o el mes
...
-- en todos los casos sume un espacio en blanco para el nombre o lo quite para ver la variacion del tama�o